...
Haryana, India<br />
              ...
              <div className="mt-8 pt-8 border-t border-blue-200">
                ...
                <div className="space-y-2">
                  <a href="/shop" className="block text-blue-600 hover:text-blue-700">Browse Books</a>
                  <a href="#" className="block text-blue-600 hover:text-blue-700">Track Your Order</a>
                  <a href="#" className="block text-blue-600 hover:text-blue-700">Return Policy</a>
                  <a href="#" className="block text-blue-600 hover:text-blue-700">Shipping Info</a>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="books">Book Availability</option>
        ...
        <div className="mt-16 bg-gray-50 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 text-sm mb-4">
                We accept returns within 7 days of delivery for unopened books in original condition. 
                Shipping charges may apply.
              </p>

              <h3 className="font-semibold text-gray-900 mb-2">Do you offer bulk discounts?</h3>
              <p className="text-gray-600 text-sm">
                Yes! We offer special pricing for schools and bulk orders. 
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mb-4">
                Standard delivery takes 3-7 business days. Express delivery options are available 
                for faster shipping.
              </p>

              <h3 className="font-semibold text-gray-900 mb-2">Are all books authentic?</h3>
              <p className="text-gray-600 text-sm mb-4">
                Absolutely! All our books are sourced directly from authorized publishers 
                and distributors. We guarantee 100% authenticity.
              </p>

              <h3 className="font-semibold text-gray-900 mb-2">Do you have books for all boards?</h3>
              <p className="text-gray-600 text-sm">
                Yes, we stock books for CBSE, ICSE, State Boards, IGCSE, IB, and other 
                educational curricula across India.
              </p>
            </div>
          </div>
        </div>
