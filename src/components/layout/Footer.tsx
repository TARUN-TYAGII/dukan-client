        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h2 className="text-l font-bold">Sandeep Trading company</h2>
                <p className="text-sm text-gray-400">Your Learning Partner</p>
              </div>
            </div>
            <p className="text-gray-300 text-sm">
              We provide quality educational books for students from Grade 1 to
              12, supporting various educational boards across India.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300 text-sm">
                  ...
                  Landmark-opposite sardar samose vala Panipat 132103 Haryana,
                  India
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-gray-400" />
                <span className="text-gray-300 text-sm">+91 7015214941</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-gray-400" />
                <span className="text-gray-300 text-sm">
                  Wisdombookscart@gmail.com
                </span>
              </div>
            </div>
